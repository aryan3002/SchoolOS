 ...
 */
import type { SISCredentials, SISConnection, HealthCheckResult, RawStudent, RawEnrollment, RawGuardian, RawGrade, RawAttendance, RawContact, RawClassSection, RawAssignment, RawRoster, SyncResult, SyncOptions, SISChange, QueryOptions, PaginatedResult, DateRange } from './sis-types';
export interface SISConnector {
     ...
     */
    getStudentAttendance(studentId: string, dateRange: DateRange): Promise<RawAttendance[]>;
    /**
...
export type { SISCredentials, SISConnection, HealthCheckResult, RawStudent, RawEnrollment, RawGuardian, RawGrade, RawAttendance, RawContact, RawClassSection, RawAssignment, RawRoster, SyncResult, SyncOptions, SISChange, QueryOptions, PaginatedResult, DateRange, };
//# sourceMappingURL=sis-connector.interface.d.ts.map