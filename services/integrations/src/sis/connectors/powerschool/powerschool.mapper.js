...
exports.PowerSchoolMapper = void 0;
const toDate = (value) => {
    if (!value) {
...
class PowerSchoolMapper {
    ...
    mapEnrollment(payload) {
        ...
        return {
            ...
            exitDate: enrollment.exitdate
                ...
                : undefined,
            schoolYear: String(enrollment.yearid ?? enrollment.school_year ?? new Date().getFullYear()),
    ...
    mapGuardian(payload) {
        ...
        return {
            ...
            relationship: cleanString(guardian.relationship) ??
            ...
            receiveCommunications: Boolean(guardian.receive_communications ?? guardian.communications ?? true),
            metadata: guardian,
        };
    }
    mapContact(payload) {
    ...
    mapGrade(payload) {
        ...
        return {
            ...
            letterGrade: grade.letter_grade ?? (grade.percent ? String(grade.percent) : undefined),
    ...
    normalizeStatus(exitCode) {
        const code = (exitCode ?? '').toString().toLowerCase();
        if (code.includes('grad'))
            return 'graduated';
...
exports.PowerSchoolMapper = PowerSchoolMapper;
//# sourceMappingURL=powerschool.mapper.js.map